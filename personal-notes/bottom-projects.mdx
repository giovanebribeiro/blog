Para criar uma seção ao fim da página inicial, contendo link para Projetos, por exemplo, basta adicionar algo assim
...
no arquivo 
    ...
    blog/minimal-blog/src/@lekoarts/gatsby-theme-minimal-blog/texts/bottom.mdx
